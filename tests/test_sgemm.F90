program test_sgemm
  ...
  print *, "================================"
  print *, "SGEMM (matrix-matrix) Tests"
  print *, "================================"
  print *, ""
  ...
  alpha = 1.0
  beta = 0.0
  call gpu_sgemm(handle, 'N', 'N', m, n, k, alpha, a%f(1,1), m, b%f(1,1), k, beta, c%f(1,1), m)
  ...
  ! =========================================
  print *, ""
  print *, "Test 3: C = A^T * B (T, N, alpha=1, beta=0)"
  total_tests = total_tests + 1
  ...
  alpha = 1.0
  beta = 0.0
  call gpu_sgemm(handle, 'T', 'N', m, n, k, alpha, a%f(1,1), k, b%f(1,1), k, beta, c%f(1,1), m)
  call gpu_download(c, c_h)
  ...
  ! =========================================
  print *, ""
  print *, "Test 4: C = A * B^T (N, T, alpha=1, beta=0)"
  total_tests = total_tests + 1
  ...
  alpha = 1.0
  beta = 0.0
  call gpu_sgemm(handle, 'N', 'T', m, n, k, alpha, a%f(1,1), m, b%f(1,1), n, beta, c%f(1,1), m)
  call gpu_download(c, c_h)
